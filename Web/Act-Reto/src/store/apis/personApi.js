...
const personApi = createApi({
    ...
    endpoints(builder) {
        return {
            ...
            fetchPan: builder.query({
                provideTags: ['PersonPan'],
                query: () => {
                    return {
                        url: `/getPan`,
                        params: {},
...
export const { useFetchPersonQuery, useFetchPanQuery, useAddPersonMutation, useEditPersonMutation, useDeletePersonMutation } = personApi;
export { personApi };